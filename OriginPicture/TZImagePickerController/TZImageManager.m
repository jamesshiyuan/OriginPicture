...
//            PHAssetResource* resource = [PHAssetResource assetResourcesForAsset:asset];
            ...
            NSDictionary *dic = [self assetMetaData:asset];
            if(![self isPureImage:dic]){
                return;
            }
...
{
    if([exifDic valueForKey:@"{MakerApple}"] != nil)
        return YES;
    else
        return NO;
}
